<template>
  <section>
    ...
    <el-table :data="resultData" highlight-current-row  border v-loading="listLoading" style="width: 100%;" :height="tableHeight"
      ...
      <el-table-column prop="Sellcode" label="出库单号"  min-width="170"  show-overflow-tooltip  header-align="center" align="center">
      ...
      <!--</el-table-column>-->
      <el-table-column prop="Pucount" label="出库数量" min-width="70"  header-align="center"  align="center">
      </el-table-column>
      <el-table-column prop="Pumoney" label="出库金额/元" min-width="80"  header-align="center"  align="center">
        <template slot-scope="scope">
          {{ scope.row.Pumoney | money(2) }}
        </template>
      </el-table-column>
      <el-table-column prop="Isoutstock" label="出库状态" min-width="70"  header-align="center"  align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="Selldate" label="出库日期"  min-width="160"   header-align="center"  align="center">
        <template slot-scope="scope">
      ...
      <el-tabs v-model="activeTabName" type="border-card" style="margin:-20px 0px -20px 0px; border:#DCDFE6 1px solid; height: 450px;">
        <el-tab-pane label="基本信息" name="tabedit">
          ...
          <el-form :model="editForm" label-width="180px" :rules="editFormRules" ref="editForm" style="margin:-20px -20px -20px -20px; border:#DCDFE6 1px solid;">
            ...
            <!--</el-col>-->
            <!--</el-form-item>-->
            <el-form-item label="出库日期" prop="Selldate" :inline-message="true">
              <el-col :span="12">
                <el-date-picker
            ...
            <el-form-item label="出库说明" prop="Selldesc" :inline-message="true" style="margin-top: 10px;">
              <el-col :span="16">
                <el-input type="textarea" v-model="editForm.Selldesc" placeholder="请输入出库说明" maxlength="100" :rows="2" clearable></el-input>
              </el-col>
            </el-form-item>
            <el-form-item label="出库金额" prop="Pumoney" :inline-message="true" style="margin-top: 10px;">
              <el-col :span="8">
                <el-input v-model="editForm.Pumoney" :disabled="true" placeholder="出库金额" maxlength="100" style="width:180px;" >
                  <template slot="append">元</template>
                </el-input>
              </el-col>
            </el-form-item>
            <el-form-item label="出库数量" prop="Pucount" :inline-message="true" style="margin-top: 10px;">
              <el-col :span="12">
                <el-input v-model="editForm.Pucount" :disabled="true" placeholder="出库金额" maxlength="100" style="width:180px;" >
                </el-input>
              </el-col>
            </el-form-item>
        ...
        <el-tab-pane label="出库产品" name="tablist">
          <span slot="label"><i class="el-icon-circle-plus"></i> 出库产品</span>
          ...
          <el-table :data="puData" highlight-current-row  border v-loading="listLoading" style="width: 100%; "  :height="350" :cell-style="this.Global.cellStyle">
            ...
            <el-table-column prop="Puprice" label="出货价/元" min-width="140"  header-align="center"  align="center">
              <template slot-scope="scope">
    ...
    <el-dialog :title="editTitle"  :visible.sync="viewFormVisible"  width="65%"  :close-on-click-modal="false">
      <div slot="title" style="font-size: 14px; font-weight: bold; color: #606266; " >
        <i class="fa fa-th-large" aria-hidden="true" style="margin-right: 10px;"></i>出库查看
      </div>
      <el-tabs v-model="activeTabName" type="border-card" style="margin:-20px 0px -20px 0px; border:#DCDFE6 1px solid; height: 450px;">
        <el-tab-pane label="基本信息" name="tabedit">
          <span slot="label"><i class="el-icon-tickets"></i> 基本信息</span>
  ...
  export default {
    ...
    methods: {
      ...
      f_InStock:function(index,row){
        let _this=this;
        this.$confirm('出库单出库会生成库存流水，确定出库吗?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
