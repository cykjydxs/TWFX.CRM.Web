<template>
  <section>
    ...
    <el-table :data="resultData" highlight-current-row  border v-loading="listLoading" style="width: 100%;" :height="tableHeight"
      ...
      <el-table-column prop="Sellcode" label="订单号"  min-width="180"  header-align="center"  align="center">
      </el-table-column>
      ...
      <el-table-column prop="Pucount" label="订单数量" min-width="70"  header-align="center"  align="center" >
      </el-table-column>
      <el-table-column prop="Pumoney" label="订单金额/元" min-width="80"  header-align="center"  align="center">
        <template slot-scope="scope">
      ...
      <el-table-column prop="Remark" label="备注" min-width="70"  header-align="center"  align="center" show-overflow-tooltip  >
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      f_Search: function () {
        ...
        _this.$httpPost('Sell/GSellDetailList', parms).then((res) => {
          if (res.success == 'ok') {
